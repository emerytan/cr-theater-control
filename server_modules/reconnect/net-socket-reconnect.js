...
module.exports= function()
{
	...
	var reconnectInterval= args.reconnectInterval || 1000
	...
	{
		console.log('reconnecting: ' + reconnectTries);
  ...
  if( reconnectOnEnd ) {
//    console.log('reconnect parameter: reconnect on end');
    socket.on('end', reconnectOnEvent)
  }
		
	if( reconnectOnClose ) {
//    console.log('reconnect parameter: reconnect on close');
		socket.on('close', reconnectOnEvent)
  }
    
	if( reconnectOnError ) {
//    console.log('reconnect parameter: reconnect on error');
    socket.on('error', reconnectOnEvent)
  }
	
  if( reconnectOnTimeout ) {
//    console.log('reconnect parameter: reconnect on timeout');
